...
export default function Desktop(props){
    ...
    return(<>
        <div {...props} style={{display:"flex",flexDirection:"column",justifyContent:"space-between",maxWidth:"25%"}}>
            <div style={{position:"relative",zIndex:5,top:"2.2em",display:"flex",flexDirection:"row",justifyContent:"space-between",paddingLeft:"5%",paddingRight:"0",maxWidth:"86%"}}>
                <div style={{display:"flex",position:'relative',zIndex:4,flexDirection:'row',width:"1.6em",height:"1.6em",borderRadius:"50%",backgroundColor:'white'}}>
                    <RiDeleteBin6Line style={{margin:'auto',fontSize:"1em"}}/>
                </div>
