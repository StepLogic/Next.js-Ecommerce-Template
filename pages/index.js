      ...
      <Layout>
          ...
          <div className={"container"}>
            <div className={"row m-10"}>
              <div className={"col-lg-6"}>
                <CategoryTileLg
                  thumbnail={category[0].thumbnail}
              ...
              <div className={"col-lg-6"}>
                ...
                >
                  ...
                  >
                    <CategoryTileSm
                      thumbnail={category[1].thumbnail}
                      category={category[1].category}
                    />
                    <CategoryTileSm
                      thumbnail={category[2].thumbnail}
                      category={category[2].category}
                    />
                  </div>
                  <CategoryTileMd
                    thumbnail={category[3].thumbnail}
        ...
        <section>
          ...
          >
            ...
            >
              <hr
                style={{ width: "26px", height: "2px", borderColor: "black" }}
              />
              <h3
                style={{
