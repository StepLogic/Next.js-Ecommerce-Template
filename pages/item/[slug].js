...
export default function Item({props}) {
    ...
    return (
        <>
            <Head>
                <title>{item}-Ecommerce</title>
                <meta name="description" content="Generated by create next app" />
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Layout>
                <section className={style.banner}  style={{backgroundColor:"rgb(245, 245, 245)"}}>

                    <div className={"container"}>
                    <div style={{display:'flex',flexDirection:"row",justifyContent:"space-between",marginTop:'1em',marginBottom:'1em'}}>
                        <div style={{display:'flex',flexDirection:"row",flexWrap:"wrap"}}>
                            <span className={style.link} style={{fontSize:"14px",marginRight:"0.2em"}}>Home</span>
                            <span style={{fontSize:"14px",marginRight:"0.2em",color:"#696969"}}><GrFormNext/></span>
                            <span className={style.link} style={{fontSize:"14px",marginRight:"0.2em"}}>test</span>
                            <span style={{fontSize:"14px",marginRight:"0.2em",color:"#696969"}}><GrFormNext/></span>
                            <span className={style.link} style={{fontSize:"14px",marginRight:"0.2em"}}>{item}</span>
                        </div>
                        <div style={{display:'flex',flexDirection:"row"}}>
                            <FiGrid style={{fontSize:"14px",marginRight:"0.2em",marginTop:'auto',marginBottom:"auto"}}/>
                            <span className={style.link} ><GrFormNext style={{fontSize:"14px",marginTop:'auto',marginBottom:"auto"}}/></span>
                        </div>
                    </div>
                    </div>
                </section>
                ...
                <section>
                    <div style={{display:"flex",flexDirection:"column",marginTop:"2em",marginBottom:"1em"}}>
                        <span style={{textAlign:"center",fontSize:"1.5rem",fontWeight:"300"}}>You may also like</span>
