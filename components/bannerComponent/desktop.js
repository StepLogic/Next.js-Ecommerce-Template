...
export default function Desktop() {
  const [currentImageList, setImageList] = useState([
    "/assets/headerCarouselImages/l.png",
    "/assets/headerCarouselImages/j.png",
    "/assets/headerCarouselImages/k.png",
  ]);
