        ...
        return(
             <>
                <div className={style.menuOverlay}
                     style={props.openCart?{position:"fixed",zIndex:4,width:"100%",height:"100%",top:0,right:0
                    ...
                    <div className={style.menu} style={{width:"80%",height:"100%",opacity:1,overflow:'scroll'}} >
                        ...
                        {cartItems}
                        {count.length>0?<button className={'btn'} style={{width:'70%',height:'2.6em',borderRadius:"50px"
